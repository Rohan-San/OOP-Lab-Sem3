// Design a C++ program for exception handling. Create a user defined exception classes for divide by zero and negative number input separately.
...
public:
    char str_what[80];
    int what;
    Negative_number(const char *s, int e)
    {
        strcpy(str_what, s);
        what = e;
    }
...
public:
    char str_what[80];
    int what;
    Divide_by_zero(const char *s, int e)
    {
        strcpy(str_what, s);
        what = e;
    }
